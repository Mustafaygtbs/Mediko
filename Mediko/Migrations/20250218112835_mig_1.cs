    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PoliclinicTimeslots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PoliclinicTimeslots_Policlinics_PoliclinicId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PoliclinicTimeslotId = table.Column<int>(type: "int", nullable: false),
                    PoliclinicId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PoliclinicTimeslotId",
                table: "Appointments",
                column: "PoliclinicTimeslotId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PoliclinicTimeslots_PoliclinicId_Date_StartTime",
